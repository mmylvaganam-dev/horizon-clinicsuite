  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        <Button onClick={() => navigate(createPageUrl('PharmacyBilling'))} className="bg-indigo-600 hover:bg-indigo-700">
          <ShoppingCart className="w-4 h-4 mr-2" />
          New Sale
        </Button>
        <Button variant="outline" onClick={() => navigate(createPageUrl('PharmacyInventory'))}>
