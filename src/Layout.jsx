  ...
  const navigationGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Nursing Staff', page: 'HomeCareStaff', icon: Users, description: 'Nursing officers - Qualified nurses providing clinical care and medical services' },
    ...
    ...(isTeleEnabled ? [{
      ...
      items: [
        ...
        ...(isVirtualHospital ? [
          ...
          { name: 'Provider Schedules', page: 'TeleProviderSchedule', icon: Clock, description: 'Manage doctor weekly availability slots and time-off — reflects live in patient booking' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Platform Telephony Config', page: 'PlatformTelephonyConfig', icon: Phone, description: 'Configure 3CX master account for all organizations' },
