...
from app.db.models import AuditLog, DocumentMetadata, Organization, Role, User, UserRole
...
def test_first_entity_models_use_uuid_primary_keys():
    for model in (Organization, Role, User, UserRole, DocumentMetadata, AuditLog):
